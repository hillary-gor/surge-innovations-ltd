            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-12">
              <div className="space-y-6 max-w-2xl">
                <div className="flex flex-wrap items-center gap-3">
                  <span className="px-3 py-1 rounded-full bg-slate-900 text-slate-100 dark:bg-slate-100 dark:text-slate-900 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-foreground">
                  Corporate <span className="text-primary">Platinum</span> Tier
                </h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Mission-critical infrastructure for enterprises. Dedicated
                  environments, data warehousing, and direct access to senior
              ...
              <div className="flex flex-col gap-4 w-full md:w-auto">
                <div className="bg-card border border-border rounded-xl p-8 shadow-lg md:min-w-85 relative overflow-hidden ring-1 ring-primary/20">
                  <div className="absolute top-0 right-0 bg-slate-900 text-white dark:bg-white dark:text-black text-xs font-bold px-3 py-1 rounded-bl-lg">
                    ENTERPRISE
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <Link 
                        href={`/contact?plan=Corporate+Platinum&price=${PRICING_DATA.platinum[currency].replace(/,/g, '')}&billing=Annual&currency=${currency}`}
                      >
                        Activate Platinum
                      </Link>
                    </Button>
            ...
            <div className="space-y-8">
              <div className="text-center md:text-left">
                ...
                <p className="text-muted-foreground mt-2 max-w-2xl">
                  For enterprise builds, the subsidy covers substantial architectural and security costs.
                </p>
              </div>
                  ...
                  <tbody className="divide-y divide-border">
                    <tr className="bg-card hover:bg-muted/20 transition-colors">
                      <td className="p-4 md:p-5">
                        ...
                        <span className="text-xs text-muted-foreground mt-1 block">
                          Microservices, Data Warehousing, Custom APIs
                        </span>
                      </td>
                      <td className="p-4 md:p-5 text-muted-foreground line-through decoration-red-500/50 decoration-2 text-right hidden md:table-cell">
                        {symbol} {PRICING_DATA.val_platinum_dev?.[currency] || "250,000"}
                      </td>
                    ...
                    <tr className="bg-foreground text-background">
                      ...
                      <td className="p-4 md:p-5 text-muted-foreground/50 line-through text-right hidden md:table-cell">
                        {symbol} {PRICING_DATA.val_platinum_total?.[currency] || "400,000"}
                      </td>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-card p-8 rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-muted-foreground text-sm mb-6">
                  Isolated infrastructure ensuring maximum security and zero resource contention.
                </p>
                <ul className="space-y-3 text-sm">
                  {[
                    { l: "Runtime:", v: "Dedicated Instance (No Shared Resources)" },
                    { l: "Uptime:", v: "99.99% Service Level Agreement" },
                    { l: "Scaling:", v: "Auto-scaling configuration" },
                  ].map((item, i) => (
              ...
              <div className="bg-card p-8 rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-muted-foreground text-sm mb-6">
                  Advanced threat protection and compliance standards.
                </p>
                <ul className="space-y-3 text-sm">
                  {[
                    { l: "Audits:", v: "Annual Penetration Testing" },
                    { l: "WAF:", v: "Enterprise Web App Firewall" },
                    { l: "Compliance:", v: "GDPR/Data Protection Ready" },
                  ].map((item, i) => (
                    <li key={i} className="flex gap-3">
                      <Check className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                      <span>
              ...
              <div className="bg-card p-8 rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow md:col-span-2">
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground text-sm mb-6">
                      Massive storage for enterprise data retention and archival.
                    </p>
                    <ul className="space-y-3 text-sm">
                      ...
                      <li className="flex gap-3">
                        ...
                        <span>
                          ...
                          Long-term cold storage options available
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="flex-1 bg-blue-50/50 dark:bg-blue-900/10 p-6 rounded-xl border border-blue-100 dark:border-blue-900/20 text-sm text-blue-900 dark:text-blue-100 leading-relaxed">
                    <p className="font-semibold mb-3 flex items-center gap-2">
                      <Info className="h-4 w-4" /> Usage Case:
                    </p>
                    &quot;Designed for organizations with heavy documentation needs, media repositories, or legal archival requirements. 100GB can store over 1 million standard PDF documents.&quot;
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Direct phone access to a Senior Engineer for architectural decisions.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-semibold text-foreground">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      2 hours of monthly engineering time allocated for content or minor logic updates.
                    </p>
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-semibold text-foreground">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Guaranteed response time for critical system outages.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-24">
          <div className="mx-auto w-full max-w-5xl px-4 md:px-6 lg:px-8">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl">
              Your {symbol} {PRICING_DATA.platinum[currency]} investment covers high-end infrastructure costs:
            </p>
                ...
                {[
                  {
                    ...
                    desc: "Isolated Instance & Auto-scaling",
                    cost: `${symbol} ${PRICING_DATA.bd_compute?.[currency] || "300,000"}`,
                  },
                  {
                    name: "Enterprise Storage",
                    desc: "100GB Warehousing & Backups",
                    cost: `${symbol} ${PRICING_DATA.bd_storage?.[currency] || "15,000"}`,
                  },
                  {
                    name: "Security Suite",
                    desc: "WAF, Pen-Testing & SSL",
                    cost: `${symbol} ${PRICING_DATA.bd_security?.[currency] || "50,000"}`,
                  },
                  {
                    name: "Retainer Hours",
                    desc: "Monthly Engineering Hours",
                    cost: `${symbol} 20,000`,
                  },
                  {
                    name: "SLA Guarantee",
                    desc: "Priority 24/7 Monitoring",
                    cost: `${symbol} 15,000`,
                  },
                ].map((item, i) => (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
                ...
                <div className="bg-amber-50 dark:bg-amber-950/30 p-3 rounded border-l-4 border-amber-500 text-xs italic text-amber-800 dark:text-amber-200">
                  &quot;If service is suspended due to non-payment, a {symbol} {PRICING_DATA.fee_reinstatement[currency]} Reinstatement Fee will be charged to re-deploy the server.&quot;
                </div>
              </div>
              ...
              <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  ...
                  infrastructure, and you own what you put inside it.
                </p>
              ...
              <div className="bg-card p-6 rounded-xl border border-border shadow-sm md:col-span-2">
                <h3 className="font-bold text-lg mb-3">3. SLA & Uptime</h3>
                <p className="text-sm text-muted-foreground">
                  This package includes a 99.99% Uptime Guarantee. Credits will be applied to the next billing cycle for any unplanned downtime exceeding the SLA threshold.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-24">
          <div className="mx-auto w-full max-w-3xl px-4 text-center">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              Secure your enterprise infrastructure and dedicated support team.
            </p>
