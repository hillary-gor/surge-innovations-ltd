...
const features = [
  {
    ...
    title: "Fast & Secure",
    description:
      "Lightning-fast performance with enterprise-grade security built in from day one.",
  },
  {
    icon: Smartphone,
    title: "Mobile-Ready",
    description:
      "Responsive designs that work flawlessly on any device, anywhere.",
  },
  {
    icon: Wrench,
    title: "Tailored Solutions",
    description:
      "Custom dashboards and workflows designed specifically for your business needs.",
  },
  {
    icon: Gauge,
  ...
  },
  {
    ...
    title: "Cloud Access",
    description:
      "Access your systems from anywhere with secure cloud infrastructure.",
  },
  {
    icon: Shield,
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="grid justify-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="p-8 bg-card hover:bg-card/80 transition-colors border-border/50 hover:border-primary/50 group w-full"
            >
